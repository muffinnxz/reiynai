            ...
            <main className="flex min-h-screen flex-col items-center justify-between">
                ...
                <section className="w-full py-12 sm:py-16 md:py-24 lg:py-32 bg-primary text-primary-foreground border border-border flex flex-col items-center">
                    <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl text-center">
                        สำรวจงการใช้ AI อย่างสร้างสรรค์ได้อย่างง่ายดาย
                    </h1>
                        ...
                        <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
                            <Card className="border border-border">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        นำทางและเรียนรู้ได้ง่ายด้วยอินเทอร์เฟซที่เข้าใจง่ายของเรา
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <p>
                            ...
                            <Card className="border border-border">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        เข้าถึงเครื่องมือ AI
                                        ที่ทรงพลังได้โดยไม่ต้องเสียค่าใช้จ่ายสูง
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <p>
                                        เรามีแผนการราคาที่แข่งขันได้เพื่อให้คุณสามารถใช้ประโยชน์จากพลังของ
                                        AI ได้โดยไม่ต้องเสียค่าใช้จ่ายสูง
                                    </p>
                                </CardContent>
                            </Card>
                            <Card className="border border-border">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        รับความช่วยเหลือเมื่อคุณต้องการด้วยทีมสนับสนุนของเรา
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <p>
                                        ทีมสนับสนุนของเราพร้อมที่จะช่วยเหลือคุณในทุกคำถามหรือปัญหาที่คุณอาจพบเจอ
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
